      ...
      <div className="row" style={{ marginTop: "50px" }}>
        <div className=" col-6 text-secondary left">
          ...
          <div className="selected" style={{marginTop: "150px"}}>
            ...
            { aSelection === "rock"? <div className="selected-rock"></div> :
              aSelection === "paper"? <div className="selected-paper"></div> :
              aSelection === "scissor"? <div className="selected-scissor"></div> : <p>None</p>
            }
          </div>
        </div>
        <div className="col-6 text-end text-secondary">
          ...
          <div className="selected-machine" style={{marginTop: "150px"}}>
            ...
            { bSelection === "rock"? <div className="selected-rockflip"></div> :
              bSelection === "paper"? <div className="selected-paperflip"></div> :
              bSelection === "scissor"? <div className="selected-scissorflip"></div> : <p>None</p>
            }
          </div>
        </div>
    </div>
